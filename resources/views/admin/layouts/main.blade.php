...
<head>
  ...
  <title>Community Center | Admin-Dashboard</title>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('admin_template/') }}/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <!-- Main Sidebar Container -->
    ...
    <a href="index3.html" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Highland CC</span>
    </a>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021 <a href="https://adminlte.io">Community Center</a>.</strong>
    All rights reserved.
